../../dan606/nyctaxi/trip data/yellow_tripdata_2019-01.csv
...
df = sc.read.format("csv").options(header='True').schema(schema).load("../../dan606/nyctaxi/trip data/yellow_tripdata_2019-01.csv")
df.printSchema()
